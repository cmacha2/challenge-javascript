...
function direcciones(laberinto, array = []) {
  ...
  if(typeof laberinto[prop]==='object'){
    array.push(prop)
    return direcciones(laberinto[prop], array)
  }
...
// < 'head --> 5 --> 3 --> 1 --> null'
//               4
LinkedList.prototype.addOLL = function (val) {
...
// BinarySearchTree.prototype.toArray = function (this) {
//     var array = []
//   if(this.value)array.push(this.value);                              
//   if(this.left){
//       array.push(this.left.value.toArray())
//     };                               
//    if(this.right){
//     array.push(this.right.value.toArray())
//     };  	                                                                             
//   return array
// };
